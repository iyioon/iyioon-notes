...
class Lab5 {
  public static String getGrade(String module, String student, String assessment,
    ...
    // Wrap the db in Actually<T>.
    Constant<Actually<Map<String, Map<String, Map<String, String>>>>> wdb = new Constant<>() {
    ...
    // Produce the String.
    Constant<String> error = new Constant<>() {
      public String init() {
    ...
    Immutator<Actually<Map<String, Map<String, String>>>, 
        ...
        = new Immutator<>() {
          public Actually<Map<String, Map<String, String>>> invoke(
              Map<String, Map<String, Map<String, String>>> db) {
            return Actually.ok(db.get(module));
          }
            };

    // Map from get(student).
    Immutator<Actually<Map<String, String>>, Map<String, Map<String, String>>> 
        getStudent = new Immutator<>() {
          public Actually<Map<String, String>> invoke(Map<String, Map<String, String>> db) {
            return Actually.ok(db.get(student));
          }
            };

    // Map from get(assessment).
    Immutator<Actually<String>, Map<String, String>> getAss = new Immutator<>() {
      public Actually<String> invoke(Map<String, String> db) {
        return Actually.ok(db.get(assessment).toString());
      }
    };

    return wdb.init().next(getModule)
        .next(getStudent).next(getAss).except(error);
  }
  ...
  public static void test2() {
    ...
    System.out.println(
        Actually.<Number>ok(9).except(zero).toString());
    System.out.println(
        Actually.<Number>err(new ArithmeticException("div by 0"))
            .except(zero).toString());
    System.out.println(
        Actually.<Number>err(new ArithmeticException("div by 0"))
            .unless(4).toString());
    System.out.println(
        Actually.<Number>ok(0).unless(4).toString());
  }
  ...
  public static void test3() {
    ...
    System.out.println(
        Actually.<Integer>ok(0).transform(inc).toString());
    System.out.println(
        Actually.<Integer>ok(0).transform(inv).toString());
    System.out.println(
        Actually.ok(0).transform(inc).toString());
    System.out.println(
        Actually.ok(0).transform(inv).toString());
    System.out.println(
        Actually.<Integer>ok(0).transform(incNum).toString());
    System.out.println(
        Actually.<Integer>ok(0).transform(invNum).toString());
    System.out.println(
        Actually.ok(0).transform(incNum).toString());
    System.out.println(
        Actually.ok(0).transform(invNum).toString());
  }
  ...
  public static void test6() {
    ...
    System.out.println(
        getGrade("CS2030S", "Steve", "lab1", nus));
    System.out.println(
        getGrade("CS2030S", "Steve", "lab2", nus));
    System.out.println(
        getGrade("CS2040S", "Steve", "lab3", nus));
    System.out.println(
        getGrade("CS2040S", "Steve", "lab4", nus));
    System.out.println(
        getGrade("CS2030S", "Tony", "lab1", nus));
    System.out.println(
        getGrade("CS2030S", "Tony", "midterm", nus));
    System.out.println(
        getGrade("CS2040S", "Tony", "lab4", nus));
    System.out.println(
        getGrade("CS2040S", "Bruce", "lab4", nus));
  }
}
