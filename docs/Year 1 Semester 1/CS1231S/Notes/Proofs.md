...
3. By [[Lecture 7 Functions#<mark style="background: FF5582A6;">Theorem 7.2.3</mark>|Theorem 7.2.3]], $f^{-1}: B \rightarrow A$ is also a bijection.
4. Therefore, $|B|=|A|$.
...
5. So by  [[Lecture 7 Functions#<mark style="background: FF5582A6;">Theorem 7.2.3</mark>|Theorem 7.2.3]], $g \circ f$ is a bijection $A \rightarrow C$.
6. Therefore, $|A|=|C|$.
