...
<span class="right-menu">[Video Part 1](https://youtu.be/zN_z7Kwfy_o) [[CS2040_14.Hashing1.pdf\|PDF]]
[Video Part 2](https://youtu.be/j_G_d8oHuq8) [[CS2040_15.Hashing2.pdf\|PDF]]
[Video Part 3](https://youtu.be/qxRIPSXrpb8) [[CS2040_16.Hashing3.pdf\|PDF]]
[Video Part 4](https://www.youtube.com/watch?v=AfIhojjMetk)[[CS2040_17.Hashing4GraphsIntro.pdf\|PDF]]
</span>
## Introduction
...
These are symbol table used throughout computer science. [[CS2040_14.Hashing1.pdf#page=7|➜PDF]]
...
Goal is to store a collection of keys. [[CS2040_16.Hashing3.pdf#page=50|Java Abstract Data Type]]. This interface can be implemented with a hash table. [[CS2040_16.Hashing3.pdf#page=52|Example|]]. 

**Disadvantage**: Too much space (buckets)

**Solution**: Use a fingerprint - only store/send $m$ bits. [[CS2040_16.Hashing3.pdf#page=56|Example|]]. 
...
Example: [[CS2040_17.Hashing4GraphsIntro.pdf#page=11|Linear Probing]] - Find the next empty bucket linearly.
...
In the case of [[CS2040_17.Hashing4GraphsIntro.pdf#page=13|Linear Probing]]:
...
[[CS2040_17.Hashing4GraphsIntro.pdf#page=15|Code]]

### Search(key)

[[CS2040_17.Hashing4GraphsIntro.pdf#page=17|Code]]
...
**Problem**: If there is a cluster, then there is a higher probability that the next $h(k)$ will hit the cluster. [[CS2040_17.Hashing4GraphsIntro.pdf#page=34|PDF]].

**Advantages:** Faster. Easier to access nearby array cells. [[CS2040_17.Hashing4GraphsIntro.pdf#page=36|PDF]].
...
[[CS2040_17.Hashing4GraphsIntro.pdf#page=38|Proof]]
...
[[CS2040_17.Hashing4GraphsIntro.pdf#page=45|Proof]]

[[CS2040_17.Hashing4GraphsIntro.pdf#page=55|Advantages & Disadvantages]]
